...
/// Starts a left/center/right capture set with its required first (left) view.
/// Later views use [AddCaptureView] and retain this draft and capture-set ID.
class CreateThreeViewDraft {
  CreateThreeViewDraft({
